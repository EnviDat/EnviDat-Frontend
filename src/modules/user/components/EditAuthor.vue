<template>
  <v-card id="EditAuthor" class="pa-4">
    <BaseIconButton
    ...
    <v-form ref="editAuthorForm">
      <v-container fluid class="pa-0">
        ...
        <v-row no-gutters>
          <v-col cols="12">
            <v-text-field :label="labels.email" ref="email" required :disabled="loading" v-model="emailField" />
          </v-col>
        </v-row>
...
import { EDITMETADATA_AUTHOR, EDITMETADATA_OBJECT_UPDATE, eventBus } from '@/factories/eventBus';
