<template>
  <v-card class="pa-4" id="EditImgPlaceholder">
    <v-row v-if="title">
      <v-col>
...
<script>
/**
 * EditImgPlaceholder.vue renders a component title, disclaimer, and an image
 *
 * @summary Renders a component title, disclaimer, and image
