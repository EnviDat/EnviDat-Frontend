<template>
  <v-card
    style="resize: both; overflow: auto; position: absolute; max-width: 100%;"
  >
    <v-btn
      small
      icon
      @click="close"
      style="position: absolute; right: 0; top: 0; z-index: 999999999999;"
    >
      <v-icon>close</v-icon>
    </v-btn>
    <v-btn
      small
      icon
      style="position: absolute; right: 0; top: 40px; z-index: 999999999999;"
      @click="download"
    >
      <v-icon>save</v-icon>
    </v-btn>
...
import FeatureInfoChart from '@/modules/metadata/components/Geoservices/FeatureInfoChart.vue';
