  ...
  >
      ...
      <v-expand-transition>
        <v-row v-show="expanded" no-gutters>
          <v-col cols="12">
            ...
            >
              <v-col cols="6" lg="3" class="headerInfo py-0">
                <BaseIconLabelView
                  :text="contactName"
            ...
            <v-row no-gutters style="position: relative; z-index: 1;">
              ...
              <v-col v-if="tags" cols="12" class="py-0" id="tags" key="tags">
                <v-row no-gutters>
                  <v-col
                  ...
                  <v-col
                    v-if="maxTagsReached && !showTagsExpanded"
                    class="shrink"
                  >
                    <tag-chip
    ...
    >
      <v-row no-gutters align="center">
        <v-col v-if="maxTagsReached" class="px-1">
          <base-icon-button
        ...
        <v-col v-if="metadataState" class="px-1">
          <MetadataStateChip
            :state="metadataState"
        ...
        <v-col v-if="hasContent" class="px-1">
