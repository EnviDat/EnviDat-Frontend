<template>
  <v-container class="pa-0 ma-0" tag="article" fluid id="BlogPage">
        ...
        <v-row no-gutters>
          ...
          >
            <BlogPostCard
              ...
              :titleCssClass="
                $vuetify.breakpoint.smAndDown ? 'text-h6 px-4' : undefined
              "
              :postDate="post.date"
  ...
  methods: {
    setBlogBodyHeight() {
      ...
      if (this.$refs?.blogHeader) {
        bodyHeaderHeight = this.$refs.blogHeader.clientHeight
          ? this.$refs.blogHeader.clientHeight
          : bodyHeaderHeight;
      }
