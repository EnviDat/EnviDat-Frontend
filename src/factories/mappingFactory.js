...
*/
  ...
  [EDITMETADATA_DATA_RESOURCE]: [
    ...
    ['resource_size-size_value','resource_size-size_value'],
    ['resource_size-size_units','resource_size-size_units'],
    ['restricted-level','restricted-level'],
    ['restricted-allowed_users','restricted-allowed_users'],
    ['restricted-shared_secret','restricted-shared_secret'],
  ],
  [EDITMETADATA_DATA_RESOURCES]: [
    ['resources','resources'],
  ],
