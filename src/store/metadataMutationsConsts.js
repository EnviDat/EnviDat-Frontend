...
export const CLEAR_SEARCH_AUTHOR = 'CLEAR_SEARCH_AUTHOR';
export const SEARCH_AUTHOR_ONLY = 'SEARCH_AUTHOR_ACTIVATE';
export const SEARCH_FULL_TEXT = 'SEARCH_FULL_TEXT';
