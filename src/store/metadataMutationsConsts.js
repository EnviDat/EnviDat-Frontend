...
export const FOREST_3D_URL = `https://forest3dtwin.${import.meta.env.VITE_ZHDK_CLOUD_HOST}/forest3dtwin/data.json`;
...
export const METADATA_UPDATE_AN_EXISTING_AUTHOR = 'METADATA_UPDATE_AN_EXISTING_AUTHOR';

export const METADATA_UPDATE_EXISTING_KEYWORDS = 'METADATA_UPDATE_EXISTING_KEYWORDS';
export const METADATA_UPDATE_EXISTING_KEYWORDS_SUCCESS = 'METADATA_UPDATE_EXISTING_KEYWORDS_SUCCESS';
export const METADATA_UPDATE_EXISTING_KEYWORDS_ERROR = 'METADATA_UPDATE_EXISTING_KEYWORDS_ERROR';
