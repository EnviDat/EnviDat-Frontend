  ...
  >
    <v-container fluid class="pa-0">
      ...
      <v-row no-gutters align="center" justify="space-between">
          ...
          <v-row no-gutters>
            <v-col class="shrink px-2">
              ...
              >
                ...
                <img :src="EnviDatLogo" alt="envidat_logo" />
              </v-btn>
            </v-col>
        ...
        <v-col v-if="signedInUser" class="shrink" cols="4" sm="3" md="2">
          <v-row align="center" justify="end">
            <v-col v-if="editingDatasetName" class="shrink">
              <BaseIconButton
                id="EditButtonNavigationToolbar"
        ...
        <v-col v-else class="shrink" cols="4" sm="2" md="1" xl="1">
