  ...
  <v-container fluid class="px-0 py-1">
    <v-row no-gutters align="start">
      <v-col class="pr-3 flex-grow-0">
        <v-row no-gutters>
          <v-col cols="12" class="pl-1 pb-2">
            <v-menu :open-on-hover="true" :open-on-click="true" :disabled="!abstract" z-index="2">
              <template v-slot:activator="{ props }">
                <BaseIcon v-bind="props" :icon="mdiInformation" :color="abstract ? 'primary' : 'grey'" />
              </template>
