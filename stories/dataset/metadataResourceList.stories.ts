...
import MetadataResourceList from '@/modules/metadata/components/Metadata/MetadataResourceList.vue';
...
const resources1 = createResources(metadata[2]);
const resources2 = createResources(metadata[0]);
...
resources2.resources[0].url =
  'https://envicloud.wsl.ch/#/?bucket=https://envicloud.wsl.ch/edna/&prefix=su_ch/su_ch_birmen_2024';

export default {
  title: '3 Datasets / 1 Views / Resource List',
  component: MetadataResourceList,
};
